...
namespace Khrussk.Extras.PolicyService {
			...
			try {
				...
				if (_received < _policyRequestString.Length) {
					_connection.BeginReceive(_buffer, _received, _policyRequestString.Length - _received,
						SocketFlags.None, new AsyncCallback(OnReceive), null); return;
				}
	...
	public class PolicyServer {
		private Socket _listener; private byte[] _policy;
		...
		public PolicyServer(string policyFile) {
			...
			_listener.Listen(10); _listener.BeginAccept(new AsyncCallback(OnConnection), null);
		}
		...
		public void OnConnection(IAsyncResult res) {
			...
			PolicyConnection pc = new PolicyConnection(client, _policy);             // look for more connections       
